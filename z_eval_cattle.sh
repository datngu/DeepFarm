...
cp /mnt/ScratchProjects/Aqua-Faang/dat_projects/dl_project/analysis_paper/selected_models/cattle_DanQ.h5 trained_results/
...
nextflow run main_eval.nf -resume \
    -w work_dir_eval \
    -name eval_cattle_${random_chars} \
